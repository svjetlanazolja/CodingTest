...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var middleBar = document.querySelector('.hamburger li:nth-child(2)');
  var bottomBar = document.querySelector('.hamburger li:nth-child(3)');
  hamburgerContainer.addEventListener('click', function () {
...
var buyOnceRadio = document.getElementById("buyOnce");
var subscribeRadio = document.getElementById("subscribe");
var buyOnceLabel = document.querySelector("label[for=buyOnce]");
var subscribeLabel = document.querySelector("label[for=subscribe]");
...
plusMinusWidgets.forEach(function (widget) {
...
function clickHandler(event) {
  var countEl = event.target.closest(".v-counter").querySelector(".count");
  var changeValue = event.target.classList.contains("plusBtn") ? 1 : -1;
  var newValue = Number(countEl.value) + changeValue;
...
$(document).ready(function () {
  $('.carousel').slick({
    ...
    // Use custom prev arrow
    nextArrow: $('.custom-next-arrow'),
    // Use custom next arrow
    responsive: [{
      breakpoint: 1024,
      settings: {
        slidesToShow: 3,
